        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(mProgramType== GeneralSettings.STACKED_PROGRAM){
                ...
                if(adType== ScheduledAd.AD_TYPE_IMAGE){
                    ...
                    double widthScale = sWidth/GeneralSettings.CANVAS_WIDTH;
                    double heightScale = sHeight/GeneralSettings.CANVAS_HEIGHT;
                    int x1,y1,x2,y2;
                    String path;
                    int adItemType;
                    ...
                    if(cAdItems!=null && cAdItems.getCount()>0){
                        ...
                        do {
                            ...
                            if(adItemType== CustomAdView.IMAGE){
                                ...
                                param.leftMargin = (int)(rScaled.left*widthScale);
                                param.topMargin = (int)(rScaled.top*heightScale);
                                param.width = (int)(rScaled.width()*widthScale);
                                param.height = (int)(rScaled.height()*heightScale);
                                ivAd.setLayoutParams(param);
                                ivAd.setImageDrawable(FileOperation.imgDrawableFromFile(Resources.getSystem(),path));
                                //ivAd.setZ(i);
                                //Adding control to the layout
