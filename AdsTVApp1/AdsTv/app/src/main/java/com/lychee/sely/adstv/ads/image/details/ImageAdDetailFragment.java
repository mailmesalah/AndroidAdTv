...
public class ImageAdDetailFragment extends DetailsFragment {
    private static final String TAG = ImageAdDetailFragment.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAd=new Ad();
        Cursor c = getActivity().getContentResolver().query(ProgramAdContentProvider.IMAGE_AD_URI, null, "_ID=?", new String[]{mAdID + ""}, null);
        if(c!=null&&c.getCount()>0){
            c.moveToFirst();
            mAd.setId(mAdID);
            mAd.setAdType(Ad.IMAGE_AD);
    ...
    private void setupFragment(){
        ...
        FullWidthDetailsOverviewRowPresenter rowPresenter = new FullWidthDetailsOverviewRowPresenter(new ImageAdDetailPresenter());
