...
public class StackedAdImageActivity extends FragmentActivity {
    ...
    private long mAdID;
    private Button mbCreateStakedAdImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stacked_ad_image);
        ...
        mtvAdName = (TextView) findViewById(R.id.text_view_ad_name_stacked_ad_image);
        ...
        mbBrowseImage = (Button) findViewById(R.id.browse_stacked_ad_image);
        mbCreateStakedAdImage = (Button) findViewById(R.id.create_stacked_ad_image);
        ...
        mbCreateStakedAdImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(cImageAd!=null&&cImageAd.getCount()>0){
                    ...
                    if(mSerialNo==0) {
                        ...
                        cv.put("AdType", StackedAd.AD_TYPE_IMAGE);
                        cv.put("AdCode",mAdID);
